const loader = document.getElementById('loader');
        ...
        function loadMainArticle() {
            ...
            let adder =  ``;
            db.collection('main').doc('main').get().then((snapshot)=>{
                 adder =  `
                <div class="mainArticle"  style="background-image: url('${snapshot.data().Picture}');"
                onclick="ONW('${String(snapshot.data().Body).replace(/[^a-zA-Z ]/g, "")}', 
                           '${String(snapshot.data()._Date)}',
                           '${String(snapshot.data().Picture)}',  
                           '${String(snapshot.data().Title).replace(/[^a-zA-Z ]/g, "")}',
                           '${String(snapshot.data().Writer).replaceAll("'", " ").replaceAll("\"", " ").replaceAll("\`", " ")}',  )">
       ...
       ${adder}
           <div class="secondaryItems">
               <div class="secondaryRow">
                   <div class="secArticle" onclick="ONW('${String(allPresenters[1].Body).replace(/[^a-zA-Z ]/g, "")}', 
                   '${String(allPresenters[1]._Date)}',
                   '${String(allPresenters[1].Picture)}',  
                   '${String(allPresenters[1].Title).replace(/[^a-zA-Z ]/g, "")}',
                   '${String(allPresenters[1].Writer).replaceAll("'", " ").replaceAll("\"", " ").replaceAll("\`", " ")}',  )" style="background-image: url('${allPresenters[1].Picture}');">
                    
                       <p class="title">${allPresenters[1].Title}</p>
                       <p class="tag"></p>
                   </div>
                   <div class="secArticle"  onclick="ONW('${String(allPresenters[2].Body).replace(/[^a-zA-Z ]/g, "")}', 
                   '${String(allPresenters[2]._Date)}',
                   '${String(allPresenters[2].Picture).replace(/[^a-zA-Z ]/g, "")}',  
                   '${String(allPresenters[2].Title).replace(/[^a-zA-Z ]/g, "")}',
                   '${String(allPresenters[2].Writer)}',  )" style="background-image: url('${allPresenters[2].Picture}');">
                    <p class="title">${allPresenters[2].Title}</p>
                    <p class="tag"></p>
                </div>
               </div>
               <div class="secondaryRow">
                <div class="secArticle"  onclick="ONW('${String(allPresenters[3].Body).replace(/[^a-zA-Z ]/g, "")}', 
                   '${String(allPresenters[3]._Date)}',
                   '${String(allPresenters[3].Picture).replace(/[^a-zA-Z ]/g, "")}',  
                   '${String(allPresenters[3].Title).replace(/[^a-zA-Z ]/g, "")}',
                   '${String(allPresenters[3].Writer).replace(/[^a-zA-Z ]/g, "")}',  )" style="background-image: url('${allPresenters[3].Picture}');">
                    <p class="title">${allPresenters[3].Title}</p>
                    <p class="tag"></p>
                </div>
                <div class="secArticle"  onclick="ONW('${String(allPresenters[4].Body).replace(/[^a-zA-Z ]/g, "")}', 
                   '${String(allPresenters[4]._Date)}',
                   '${String(allPresenters[4].Picture).replace(/[^a-zA-Z0-9 ]/g, "")}',  
                   '${String(allPresenters[4].Title).replace(/[^a-zA-Z ]/g, "")}',
                   '${String(allPresenters[4].Writer).replace(/[^a-zA-Z ]/g, "")}',  )" style="background-image: url('${allPresenters[4].Picture}');">
